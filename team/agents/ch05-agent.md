...
- **다음 Ch.6으로 보내는 것**: Component ablation 결과와 marginal ROI 순위(Ch.6 Operational Compiler 구성 우선순위의 근거). Optimal harness overhead 구간. "도구화하면 안 되는 것"의 조건(E21, E22에서 확인된 항목).
